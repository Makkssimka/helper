...
class ErrorHandler
{
    private $levels = [
        ...
        \E_USER_ERROR => 'User ErrorController',
        \E_RECOVERABLE_ERROR => 'Catchable Fatal ErrorController',
        \E_COMPILE_ERROR => 'Compile ErrorController',
        \E_PARSE => 'Parse ErrorController',
        \E_ERROR => 'Error',
        \E_CORE_ERROR => 'Core ErrorController',
    ];
     ...
     *
     * @param array $loggers ErrorController levels to [LoggerInterface|null, LogLevel::*] map
     *
